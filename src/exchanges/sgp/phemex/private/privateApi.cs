...
namespace CCXT.NET.Phemex.Private
{
    /// <summary>
    ///
    /// </summary>
        ...
        public override XApiClient privateClient
        {
            get
            {
                if (base.privateClient == null)
                {
                    ...
                    base.privateClient = new PhemexClient(_division, __connect_key, __secret_key);
                }
        ...
        public override CCXT.NET.Shared.Coin.Public.PublicApi publicApi
        {
            get
            {
                if (base.publicApi == null)
                    base.publicApi = new CCXT.NET.Phemex.Public.PublicApi();
