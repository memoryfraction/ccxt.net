...
namespace CCXT.NET.Kucoin.Private
{
    /// <summary>
    ///
    /// </summary>
        ...
        public override XApiClient privateClient
        {
            get
            {
                if (base.privateClient == null)
                {
                    ...
                    base.privateClient = new KucoinClient(_division, __connect_key, __secret_key);
                }
        ...
        public override CCXT.NET.Shared.Coin.Public.PublicApi publicApi
        {
            get
            {
                if (base.publicApi == null)
                    base.publicApi = new CCXT.NET.Kucoin.Public.PublicApi();
